...
import { Baby, Lock, User as UserIcon, LogIn, Calculator } from 'lucide-react';
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-slate-500 text-xs">Atau</span>
              </div>
            </div>

            <button
              onClick={() => navigate('/guest')}
              className="mt-6 w-full flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-semibold text-slate-600 bg-white border border-slate-200 hover:bg-slate-50 hover:text-sky-600 hover:border-sky-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 transition-all shadow-sm"
            >
              <Calculator size={16} />
              Coba Fitur Pengukuran (Guest)
            </button>
          </div>
        </div>
